...
object PasswordPolicyDefault:
  /**
   * Password Policy with minimum length of 3 characters (alphanumeric + some symbols) and maximum of 20 (default of PasswordPolicyBuilder)
   */
  val SIMPLE: PasswordPolicy = PasswordPolicyBuilder() minimumLength 3 build
  /**
   * Password Policy with minimum length of 8 characters (alphanumeric + some symbols) and maximum of 20 (default of PasswordPolicyBuilder)
   */
  ...
  /**
   * Password Policy with minimum length of 10 characters (alphanumeric + some symbols) and maximum of 20 (default of PasswordPolicyBuilder)
