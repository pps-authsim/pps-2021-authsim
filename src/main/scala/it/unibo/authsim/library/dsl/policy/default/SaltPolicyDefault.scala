...
object SaltPolicyDefault:
  /**
   * Salt Policy with minimum length of 3 characters (alphanumeric + some symbols) and maximum of 20 (default of SaltPolicyBuilder)
   */
  val SIMPLE: SaltPolicy = SaltPolicyBuilder() minimumLength 3 build
  /**
   * Salt Policy with minimum length of 5 characters (alphanumeric + some symbols) and maximum of 20 (default of SaltPolicyBuilder)
   * and at least 1 symbols
   */
  val MEDIUM: SaltPolicy = SaltPolicyBuilder() minimumLength 5 minimumSymbols 1 build
  /**
   * Salt Policy with minimum length of 8 characters (alphanumeric + some symbols) and maximum of 20 (default of SaltPolicyBuilder)
  ...
  /**
   * Salt Policy with minimum length of 10 characters (alphanumeric + some symbols) and maximum of 20 (default of SaltPolicyBuilder)
