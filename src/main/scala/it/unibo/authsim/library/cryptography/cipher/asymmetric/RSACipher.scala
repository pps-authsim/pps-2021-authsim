package it.unibo.authsim.library.cryptography.cipher.asymmetric

import it.unibo.authsim.library.cryptography.algorithm.AsymmetricAlgorithm
import it.unibo.authsim.library.cryptography.algorithm.asymmetric.RSA
import it.unibo.authsim.library.cryptography.cipher.asymmetric.key.{KeyPair, KeysGenerator}
import it.unibo.authsim.library.cryptography.util.Base64
import it.unibo.authsim.library.cryptography.cipher.{AsymmetricCipher, BasicCipher}
...
object RSACipher:
  ...
  case class BasicRSACipher() extends BasicCipher with AsymmetricCipher:
     ...
     */
    override val algorithm: RSA= RSA()
